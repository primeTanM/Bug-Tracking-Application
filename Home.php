...
//echo "<a href='change_status_e.php?ID={$row['id']}'><h4>Change Status</h4></a>";
...
if($_SESSION['type']=="QA"){
//echo "<a href='add_comment.php?ID={$row['id']}'><h4>Add Comments</h4></a>";
...
if($_SESSION['type']=="ADM"){
echo "<a href='delete_post.php?ID={$row['id']}'><button>Delete Post</button></a>";
}echo "</div>";
}
?>


    <!-- //     <h4 class="item"> {$row['status']} </h4> 
    //     <div class="des item">
    //       {$row['description']}
    //     </div>

    //     <h4 class="item">Comments</h4>
    //     <div class="com item">'{$row['username']}'</div>
    // </div>';
